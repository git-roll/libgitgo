...
func getDownloadTags(v string) gitgo.DownloadTags {
	switch v {
	case "DownloadTagsUnspecified":
		return gitgo.DownloadTagsUnspecified
	case "DownloadTagsAuto":
		return gitgo.DownloadTagsAuto
	case "DownloadTagsNone":
		return gitgo.DownloadTagsNone
	case "DownloadTagsAll":
		return gitgo.DownloadTagsAll
	case "":
		return 0
	}
...
func getSubmoduleRescursivity(v string) gogit.SubmoduleRescursivity {
	switch v {
...
func getTagMode(v string) gogit.TagMode {
	switch v {
	case "TagFollowing":
